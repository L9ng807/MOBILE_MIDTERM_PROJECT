...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 15, fontWeight: '700', marginTop: 8, marginBottom: 10, color: colors.text },
  barBlock: { marginBottom: 14 },
  barHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  barLabel: { fontWeight: '600', color: colors.text }, barValue: { color: colors.textMuted, fontSize: 12 }, barTrack: { height: 10, backgroundColor: colors.surfaceElevated, borderRadius: 6, overflow: 'hidden', marginTop: 6 }, barFill: { height: 10, backgroundColor: colors.primary, borderRadius: 6 }, card: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 12, padding: 16, gap: 8, marginBottom: 24 },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  label: { color: colors.textMuted, flex: 1, marginRight: 12 }, value: { fontWeight: '600', flexShrink: 0, textAlign: 'right', color: colors.text }, hint: { color: colors.textMuted, fontSize: 12, marginTop: 4, marginBottom: 8 },
});
